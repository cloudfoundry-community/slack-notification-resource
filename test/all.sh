...
test oauth_token | jq -e "
  .webhook_url == \"https://slack.com/api/chat.postMessage\" and
  .body.channel == \"#another_channel\" and
  .body.icon_url == null and
  .body.icon_emoji == null and
  .body.link_names == false and
...
test oauth_token_with_text_file | jq -e "
  .webhook_url == \"https://slack.com/api/chat.postMessage\" and
  .body.text == \"This text came from sample.txt. It could have been generated by a previous Concourse task.\n\nMultiple lines are allowed.\n\" and
  .body.channel == null and
  .body.icon_url == null and
  .body.icon_emoji == null and
  .body.link_names == false and
...
test oauth_token_with_text_file_and_env_vars | jq -e "
  .webhook_url == \"https://slack.com/api/chat.postMessage\" and
  .body.text == \"This text came from sample.txt. It could have been generated by a previous Concourse task.\n\nMultiple lines are allowed.\n\nBUILD_NAME=my-build\nVERSION=1.0.1\nQUALITY_GATE=B (ERROR)\nWITH_PIPE=<something>\nwith_GLOB=./path/to/*.jar\n\" and
  .body.channel == null and
  .body.icon_url == null and
